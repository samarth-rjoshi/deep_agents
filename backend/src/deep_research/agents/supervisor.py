...
from deep_research.agents.research import researcher_agent
from deep_research.state.supervisor import (
    SupervisorState, 
    ConductResearch, 
    ResearchComplete
)
...
supervisor_model = init_model(model=os.getenv("GENERATION_MODEL", "gpt-4o"))
